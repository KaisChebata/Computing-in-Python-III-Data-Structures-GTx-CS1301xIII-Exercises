...
def write_file(file_name, data):
	...
	# converting data to str type even if it is orginally a str, 
	# because its have cheaper cost than checking the type if str or not.
...
#print nothing. However, if you open WriteFileOutputTest.txt
#in the top left after running it, the contents of the
#file should be 1301.
write_file(r"Chapter 4.4 - File Input and Output\\WriteFileOutputTest.txt", 1301)
